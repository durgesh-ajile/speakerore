...
const Viewdetails = () => {
  const eventdata = {
    ...
    location: "The Hive- Flexible Workspace, Gachibowli Hyderabad The Hive Nanakaramguda, TG 500032",
    audience_number: 100,
      ...
      <div className="venue-details">
        ...
        <div className="venue-details-container">
                ...
                <div className="audience box">
                    <bold>Audience</bold>
                    <span>{eventdata.audience_number}</span>
                    <span>{eventdata.audience_type}</span>
                </div>
        </div>
